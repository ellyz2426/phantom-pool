...
export const THEMES: ThemeColors[] = [
  ...
  },
  {
    ...
    id: 'blood',
    feltColor: 0x1a0808,
    feltEmissive: 0x0d0404,
    feltEmissiveIntensity: 0.5,
    railColor: 0x1a0808,
    railEmissive: 0x440011,
    pocketGlow: 0xff2200,
    pocketOuterGlow: 0xcc0000,
    wireframeColor: 0xff4433,
    diamondColor: 0xff4433,
    edgeGlowColor: 0xff3322,
    primaryLight: 0xff3322,
    secondaryLight: 0xff6600,
    tertiaryLight: 0x880022,
    fogColor: 0x080202,
    gridColor: 0x330808,
    signPrimary: 0xff4433,
    signSecondary: 0xffaa00,
    ballGlowTint: 0xff3322,
    particleColors: [0xff3322, 0xff6600, 0xffaa00, 0xff0044, 0xcc2200],
  },
  {
    name: 'ARCTIC FROST',
    id: 'frost',
    feltColor: 0x0a1a2a,
    feltEmissive: 0x051015,
    feltEmissiveIntensity: 0.4,
    railColor: 0x0a1520,
    railEmissive: 0x112844,
    pocketGlow: 0x44ccff,
    pocketOuterGlow: 0x2299dd,
    wireframeColor: 0x88ddff,
    diamondColor: 0x88ddff,
    edgeGlowColor: 0x66ccff,
    primaryLight: 0x88ddff,
    secondaryLight: 0xaaeeff,
    tertiaryLight: 0x4488cc,
    fogColor: 0x030810,
    gridColor: 0x112233,
    signPrimary: 0x88ddff,
    signSecondary: 0xccffff,
    ballGlowTint: 0x88ddff,
    particleColors: [0x88ddff, 0xaaeeff, 0xccffff, 0x44ccff, 0x66aadd],
  },
];
